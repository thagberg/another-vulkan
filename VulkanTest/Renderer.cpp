...
namespace hvk {
	...
	void Renderer::init(
		...
		VkRenderPassCreateInfo renderPassCreate = { VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO };
		...
		assert(vkCreateRenderPass(mDevice.device, &renderPassCreate, nullptr, &mRenderPass) == VK_SUCCESS);
